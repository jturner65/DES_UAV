...
public abstract class myDrawnObject {
	...
	public myDrawnObject(UAV_DESSim _pa, myVector _canvNorm) {
		pa = _pa;
...
class myVariStroke extends myDrawnObject {
	...
	public myVariStroke(UAV_DESSim _pa, myVector _canvNorm, int fillClrCnst, int strkClrCnst) {
		super(_pa, _canvNorm);
...
class cntlPt extends myPoint {
	...
	public cntlPt(UAV_DESSim _pa, myPoint _p, float _r, float _w){ super(_p.x,_p.y, _p.z); pa=_pa; ID=IDincr++;r=_r; w=_w; }
	public cntlPt(UAV_DESSim _pa, myPoint _p, float _w){this(_pa, _p, baseRad, _w);}
	public cntlPt(UAV_DESSim _pa, myPoint _p){this(_pa, _p, baseRad, baseRad);}
	public cntlPt(UAV_DESSim _pa){this(_pa, _pa.P(),1);}
...
abstract class myOffset {
	...
	public myOffset(UAV_DESSim _pa, boolean _ec){
		pa = _pa;
		ID = IDcnt++;
		endCaps = _ec;
	}	
	
	public myOffset(UAV_DESSim _pa){this(_pa, true);}
...
class myNormOffset extends myOffset{
	myNormOffset(UAV_DESSim _pa){super(_pa); name = "Normal offset";}
