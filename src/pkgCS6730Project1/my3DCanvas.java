...
public class my3DCanvas {
	...
	public my3DCanvas(UAV_DESSim _p) {
		p = _p;
...
class edge{ 
	public UAV_DESSim p;
	public myPoint a, b;
	public edge (UAV_DESSim _p){this(_p,new myPoint(0,0,0),new myPoint(0,0,0));}
	public edge (UAV_DESSim _p, myPoint _a, myPoint _b){p = _p;a=new myPoint(_a); b=new myPoint(_b);}
