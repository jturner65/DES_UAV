...
public abstract class myEntity {	
	...
	protected void dispEntityLabel(UAV_DESSim pa) {
		pa.unSetCamOrient();
		pa.pushMatrix();pa.pushStyle();
			pa.translate(labelVals[0],labelVals[1],labelVals[2]);
			pa.setFill(lblColors);
			pa.scale(.5f,.5f,.5f);
	...
	//draw this entity
	public abstract void drawEntity(UAV_DESSim pa, float delT, boolean drawMe, boolean drawLbls);
...
enum EntityType {
	...
	public static int EntityType(){return map.size();}						//get # of values in enum	
};
